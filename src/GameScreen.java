...
public class GameScreen extends JPanel implements Runnable, KeyListener {
    ...
    public void gameOver(){
        if (score < points) {
            ...
            try {
                out = new PrintWriter("src/GameSaves/scores.txt");
            ...
            switch (e.getKeyCode()) {
                case KeyEvent.VK_UP:
                    if (player.PlayerY >= GROUND - Player.PlayerSizeY) {
                        ...
                        try {
                            SOUND = Applet.newAudioClip(new URL("file","","src/data/audio/jump.wav"));
    ...
    @Override
    public void run() {
        File file = new File("src/GameSaves/scores.txt");
        Scanner in = null;
        try {
            in = new Scanner(file);
        } catch (FileNotFoundException e) {
    ...
    public void  paint(Graphics g){
        ...
        switch (gameState) {
            ...
            case GAME_OVER_STATE -> {
                ...
                try {
                    SOUND =  Applet.newAudioClip(new URL("file","","src/data/audio/winXP.wav"));
