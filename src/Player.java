...
public class Player {
    ...
    public Player() throws IOException {
        image = ImageIO.read(new File("src/data/images/Player.png"));
        image2 = ImageIO.read(new File("src/data/images/PlayerBoss.png"));
        image3 = ImageIO.read(new File("src/data/images/Player_squat.png"));
        image4 = ImageIO.read(new File("src/data/images/PlayerBoss_squat.png"));
    }
    ...
    public void draw(Graphics g) throws IOException {
        ...
        if(GameScreen.T || GameScreen.points > 1_000) {
            if(GameScreen.crouch)
                ...
                if (plr) {
                    try {
                        BOSS_SOUND = Applet.newAudioClip(new URL("file", "", "src/data/audio/1up.wav"));
